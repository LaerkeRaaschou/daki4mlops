...
def main(cfg: DictConfig):
    ...
    model = initialize_model(cfg.num_classes, cfg.weights_path)
    test_loader = get_test_loader(cfg.batch_size, cfg.data_path)
    total_stats, class_stats = test_model(model, test_loader)
    report_statistics(total_stats, class_stats, cfg.save_stats_path)
